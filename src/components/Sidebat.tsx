...
const menuItems = [
  ...
  { path: "/products", label: "Mahsulotlar va Ombor", icon: <Box size={18}/> },
  { path: "/analytics", label: "Statistika va Analitika", icon: <BarChart2 size={18}/> },
  { path: "/subscriptions", label: "Obunalar", icon: <CreditCard size={18}/> },
  { path: "/activity", label: "Faollik monitoringi", icon: <Activity size={18}/> },
  { path: "/settings", label: "Sozlamalar", icon: <Settings size={18}/> },
  { path: "/support", label: "Xabarlar va Qollab-quvvatlash", icon: <MessageSquare size={18}/> },
